...
// Message builders for: ADT_A01
// Run: bun src/hl7v2/codegen.ts ADT_A01 --messages

import type { HL7v2Segment, HL7v2Message } from "../src/hl7v2/types";
import {
  ACCBuilder,
  AL1Builder,
  DB1Builder,
...
export class ADT_A01_PROCEDUREBuilder {
  ...
  build(): ADT_A01_PROCEDURE { return this.group as ADT_A01_PROCEDURE; }
}
...
export class ADT_A01_INSURANCEBuilder {
  ...
  build(): ADT_A01_INSURANCE { return this.group as ADT_A01_INSURANCE; }
}
